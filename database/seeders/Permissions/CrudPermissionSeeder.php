...
class CrudPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->aclService->createScopePermissions('media_posts', ['create', 'read', 'read_own', 'update', 'update_own', 'patch', 'delete']);
        ...
        $this->aclService->assignScopePermissionsToRole($creatorRole, 'media_posts', ['read_own', 'update_own']);

        $clientRole = Role::where('name', ROLE_ENUM::CLIENT)->first();
        $this->aclService->assignScopePermissionsToRole($clientRole, 'projects', ['create', 'read_own', 'update_own', 'delete', 'invite_creator', 'read_own_proposals', 'manage_proposals', 'manage_comments', 'manage_assignees']);
        ...
        $this->aclService->assignScopePermissionsToRole($clientRole, 'media_posts', ['create', 'read_own', 'update', 'patch', 'delete']);
