...
class CrudPermissionSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $this->aclService->assignScopePermissionsToRole($clientRole, 'projects', ['create', 'read_own', 'update', 'delete', 'invite_creator', 'read_own_proposals', 'manage_proposals', 'manage_comments', 'manage_assignees']);
